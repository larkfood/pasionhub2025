...
use App\Http\Controllers\Api\User\Update\DarkMode;
...
use App\Http\Controllers\Api\User\Update\Settings;
...
{
	use Register, Update, VerificationTrait, Settings, Photo, DarkMode, Delete, Stats;
	 ...
	 * @return \Illuminate\Http\JsonResponse
	 */
	public function updateSettings($id, UserSettingsRequest $request): \Illuminate\Http\JsonResponse
	{
